...
var organizations = [
  ...
  },
  {
    ...
    position:
      "Webmaster (January 2017 — April 2018)<br>Head Social Media Chair (January 2017 — April 2018)",
  },
  {
    time: "August 2014 — January 2018",
    name: "Michigan Marching Band",
    position:
      "Rank Leader (August 2017 — January 2018)<br>Mellophone (August 2014 — January 2018)",
  },
  {
...
var jobs = [
  {
    ...
    location: "Stealth Start-Up (Remote)",
    description:
      "Founding and first software engineer. Lead engineering stand-ups and cross-team discussions for the business and engineering team. Created wireframes and mock-ups for the new React front-end using Balsamiq and Figma. Replaced Flask front-end with redesigned front-end using React.js. Rewrote Flask API endpoints to connect to the React front-end. Used AWS CodeCommit and GitLab for source control. Pulled data from PostgreSQL DB to be rendered on the React front-end. Developed add-in for Front.com and Outlook.com",
  },
  {
    ...
    description:
      "I hold discussion sections where I help students with their project, which entails need-finding, designing, and refining their problem statements.",
  },
  {
    ...
    location: "Northwestern University (Evanston, IL)",
    description:
      "I help answer students' questions regarding machine learning and related homework. In addition, I also help grade the assignments.",
  },
  {
  ...
  },
  {
    ...
    location: "Avomeen (Ann Arbor, MI)",
    description:
      "I did research and development with cGMP documentation on extractables and leachables testing of pharmaceutical products as well as impurities testing of nicotine products using GC-MS, GC-FID, HPLC, ICP-MS, and LC-MS.",
  },
  {
...
var awards = [
  {
    ...
    location: "Avomeen (Ann Arbor, MI)",
    description:
      "Nominated and selected for having great compliance and lab work documentation.",
  },
  {
    time: "February 2020",
    ...
    location: "Avomeen (Ann Arbor, MI)",
    description:
      "Group award for having the best on time delivery in the company.",
  },
];
